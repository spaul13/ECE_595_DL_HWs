...
enable_smoothing = 0 #set this variable to 1 to enable smoothing
...
def main():
    ...
    for i in len(range(confusion_matrix)):
    ...
    for i in range(len(max_index_list)):
        ...
        if(max_index == 0):
            ...
            model2 = detector.LOADnet2(skip_connections=True, depth=32)
            print("\n ... training for depth 32 .... \n")
            ...
            model3 = detector.LOADnet2(skip_connections=True, depth=32)
            print("\n ... training for depth 32 .... \n")
            ...
            model4 = detector.LOADnet2(skip_connections=True, depth=32)
            print("\n ... training for depth 32 .... \n")
